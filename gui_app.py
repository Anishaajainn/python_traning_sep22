...
ttk.Label(app, text = 'Anisha Jain').place(x=60,y=60)
...
ttk.Button(app, text = 'Isko Click Karo', command = abc, font=('Arial',25)).place(x=100,y=120)
ttk.Button(app, text = 'Ye wala bhi hai', command = lambda:msg.set('pata nhi')).place(x=100,y=170)
